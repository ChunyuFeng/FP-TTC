...
from utils.nusc_paths import (
    infer_nusc_dataset_root,
    make_nusc_relative_path,
    resolve_nusc_depth_pred_path,
)
...
def main():
    ...
    for split in args.splits:
        ...
        for original_index, info in tqdm(iterator, total=(len(infos) if args.max_samples is None else min(len(infos), args.max_samples)), desc=f'Caching {split}'):
